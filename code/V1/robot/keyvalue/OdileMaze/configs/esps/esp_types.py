...
class ESP_VALUE_TYPE_KEYS(Enum):
    ...
    JOY_VR_TRIG = 'Rbt'
    JOY_VR_GRAB = 'Rbg'
    ACC_LEFT_JOY_VR_X = 'Lrx'
    ACC_LEFT_JOY_VR_Y = 'Lry'
    ACC_LEFT_JOY_VR_Z = 'Lrz'
    LEFT_JOY_VR_X = 'Ljx'
    LEFT_JOY_VR_Y = 'Ljy'
    LEFT_JOY_VR_TRIG = 'Lbt'
...
esp_value_types = {
    ...
    # --- Joystick VR
    ESP_VALUE_TYPE_KEYS.ACC_JOY_VR_X.value:
        EspValueType(ESP_VALUE_TYPE_KEYS.ACC_JOY_VR_X.value, ESP_CHANNEL_TYPE.MULTI_VALUE, 0, 255),
    ESP_VALUE_TYPE_KEYS.ACC_JOY_VR_Y.value:
        EspValueType(ESP_VALUE_TYPE_KEYS.ACC_JOY_VR_Y.value, ESP_CHANNEL_TYPE.MULTI_VALUE, 0, 255),
    ESP_VALUE_TYPE_KEYS.ACC_JOY_VR_Z.value:
        EspValueType(ESP_VALUE_TYPE_KEYS.ACC_JOY_VR_Z.value, ESP_CHANNEL_TYPE.MULTI_VALUE, 0, 255),
    ESP_VALUE_TYPE_KEYS.JOY_VR_X.value:
        EspValueType(ESP_VALUE_TYPE_KEYS.JOY_VR_X.value, ESP_CHANNEL_TYPE.MULTI_VALUE, 0, 255),
    ESP_VALUE_TYPE_KEYS.JOY_VR_Y.value:
        EspValueType(ESP_VALUE_TYPE_KEYS.JOY_VR_Y.value, ESP_CHANNEL_TYPE.MULTI_VALUE, 0, 255),
    ESP_VALUE_TYPE_KEYS.JOY_VR_TRIG.value:
        EspValueType(ESP_VALUE_TYPE_KEYS.JOY_VR_TRIG.value, ESP_CHANNEL_TYPE.MULTI_VALUE, 0, 255),
    ESP_VALUE_TYPE_KEYS.JOY_VR_GRAB.value:
        EspValueType(ESP_VALUE_TYPE_KEYS.JOY_VR_GRAB.value, ESP_CHANNEL_TYPE.MULTI_VALUE, 0, 255),
    ESP_VALUE_TYPE_KEYS.ACC_LEFT_JOY_VR_X.value:
        EspValueType(ESP_VALUE_TYPE_KEYS.ACC_LEFT_JOY_VR_X.value, ESP_CHANNEL_TYPE.MULTI_VALUE, 0, 255),
    ESP_VALUE_TYPE_KEYS.ACC_LEFT_JOY_VR_Y.value:
        EspValueType(ESP_VALUE_TYPE_KEYS.ACC_LEFT_JOY_VR_Y.value, ESP_CHANNEL_TYPE.MULTI_VALUE, 0, 255),
    ESP_VALUE_TYPE_KEYS.ACC_LEFT_JOY_VR_Z.value:
        EspValueType(ESP_VALUE_TYPE_KEYS.ACC_LEFT_JOY_VR_Z.value, ESP_CHANNEL_TYPE.MULTI_VALUE, 0, 255),
    ESP_VALUE_TYPE_KEYS.LEFT_JOY_VR_X.value:
        EspValueType(ESP_VALUE_TYPE_KEYS.LEFT_JOY_VR_X.value, ESP_CHANNEL_TYPE.MULTI_VALUE, 0, 255),
    ESP_VALUE_TYPE_KEYS.LEFT_JOY_VR_Y.value:
        EspValueType(ESP_VALUE_TYPE_KEYS.LEFT_JOY_VR_Y.value, ESP_CHANNEL_TYPE.MULTI_VALUE, 0, 255),
    ESP_VALUE_TYPE_KEYS.LEFT_JOY_VR_TRIG.value:
        EspValueType(ESP_VALUE_TYPE_KEYS.LEFT_JOY_VR_TRIG.value, ESP_CHANNEL_TYPE.MULTI_VALUE, 0, 255)
}